export default function Calendar() {
	return (
		<div className="flex flex-col items-center pb-16 my-2 space-y-2 font-bold text-gray-700">
			<div className="flex flex-col w-full space-y-4">
				<div class="flex items-center justify-center">
					<div class="max-w-sm w-full">
						<div class="md:p-8 p-5 dark:bg-gray-800 rounded-lg">
												...
												<div class="px-2 py-2 cursor-pointer flex w-full justify-center">
													<div class="flex items-center justify-center w-full rounded-full cursor-pointer">
														<a
															role="link"
															tabindex="0"
															class="focus:outline-none  focus:ring-2 focus:ring-offset-2 focus:ring-blue-700 focus:bg-blue-500 hover:bg-blue-500 text-base w-8 h-8 flex items-center justify-center font-medium text-white bg-blue-700 rounded-full"
														>
															20
														</a>
													</div>
						...
						<div class="md:py-8 py-5 md:px-16 px-5 dark:bg-gray-700 bg-gray-50 rounded-b">
							<div class="px-4">
								<div class="border-b pb-4 border-gray-400 border-dashed">
									<p class="text-xs font-light leading-3 text-gray-500 dark:text-gray-300 mb-2">
										6:00 PM
									</p>
									<a
										tabindex="0"
									...
									>
										Software Engineering Project Dissertation Class
									</a>
